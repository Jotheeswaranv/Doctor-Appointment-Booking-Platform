  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Sparkle <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Sparkle Plus, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Sparkle Plus, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Sparkle Plus is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2004-2025 Sparkle+. All rights reserved.</p>
      </div>
    </div>
  );
}

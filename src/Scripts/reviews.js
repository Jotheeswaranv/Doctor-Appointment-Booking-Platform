export const customerReviews = [
    {
      "name": "Pooja Ramaraj",
      "location": "Texas, USA",
      "message": "Joe Sparkle Plus transformed my healthcare experience! The online consultations were so convenient, and the doctors were knowledgeable and caring."
    },
    {
      "name": "Narmada Smith",
      "location": "California, USA",
      "message": "I found the perfect specialist for my condition through Joe Sparkle  Plus. The personalized treatment plan made all the difference. Thank you for prioritizing my health!"
    },
    {
      "name": "Alex HariKumar ",
    ...
    },
    {
      ...
      "message": "Joe Sparkle Plus is a game-changer! The emergency care saved me during a critical situation. Grateful for their quick and efficient support."
    },
    {
      "name": "VasudevKrishnan",
